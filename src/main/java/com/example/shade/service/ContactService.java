...
public class ContactService {
    ...
    private InlineKeyboardMarkup createContactKeyboard(Long chatId) {
        ...
        // 1 - Admin button
        rows.add(List.of(createButton(languageSessionService.getTranslation(chatId, "contact.button.admin"), "https://t.me/BaronPey")));

        // 2 - Chat button
        rows.add(List.of(createButton(languageSessionService.getTranslation(chatId, "contact.button.chat"), "https://t.me/BaronPey_Kassa")));
